...
public class TabAsentamientoNM extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ListView list=(ListView) view.findViewById(R.id.listaAsentamientoNM);
        ArrayAdapter<String> adapter=new ArrayAdapter<>(getActivity(),android.R.layout.simple_list_item_1,guia4);
